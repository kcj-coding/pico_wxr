...
def web_page():
  ...
  </style></head><body><h1>Kelvi's BME280 Pi Pico W Weather Station</h1>
  <table><tr><th>Parameters</th><th>Value</th></tr>
  <tr><td>Temperature</td><td><span class="sensor">""" + str(round(temperature,3))+"C" + """</span></td></tr>
  <tr><td>Pressure</td><td><span class="sensor">""" + str(round(pressurehpa,2)) + 'hPa' + """</span></td></tr>
  <tr><td>Humidity</td><td><span class="sensor">""" + str(round(humidity,2)) + '%' + """</span></td></tr>
  <tr><td>CPU Temp</td><td><span class="sensor">""" + str(round(temperature_internal,2))+"C" + """</span></td></tr>
  <tr><td>Runtime (YYYY-MM-DD HH:MM:SS)</td><td><span class="string">""" + str(timestring)+ """</span></td></tr>
